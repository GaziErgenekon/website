...
const LightboxGallery = lazy(() => import("../components/common/LightboxGallery"));
          ...
          <div className="w-full md:w-1/2 space-y-6">
            ...
            <div className="bg-white/5 p-8 rounded-2xl border border-white/10">
              <p className="text-lg leading-relaxed text-foreground/80">
                IDEF (Uluslararası Savunma Sanayii Fuarı), Türkiye'de düzenlenen
                ve dünyanın en büyük savunma sanayi fuarlarından biri olan
                prestijli bir organizasyondur. Türk Silahlı Kuvvetlerini
                Güçlendirme Vakfı yönetim ve sorumluluğunda gerçekleştirilen
                fuar; savunma, güvenlik, denizcilik, havacılık ve uzay sanayii
                alanlarında en son teknolojilerin sergilendiği küresel bir
                buluşma noktasıdır.
              </p>
            </div>
          </div>
        ...
        <div className="mb-24 bg-gradient-to-r from-background via-white/5 to-background p-8 md:p-12 rounded-3xl border border-white/10">
          <div className="max-w-4xl mx-auto text-center space-y-8">
            ...
            <p className="text-xl text-foreground/70 leading-relaxed">
              ...
              <strong>Defenders of Tomorrow (DOT)</strong> alanı, savunma
              sanayiinin geleceğini şekillendirecek genç yeteneklere ve inovatif
              girişimlere ayrılmış özel bir bölümdür. Geleceğin savunucuları
              olarak, burada projelerimizi sektör liderlerine, askeri heyetlere
              ve uluslararası yatırımcılara tanıtma fırsatı bulduk.
            </p>
          </div>
        </div>
            ...
            <div className="relative z-10 flex flex-col items-center justify-center h-full text-center space-y-6 p-8">
              ...
              <div className="space-y-2">
                ...
                <p className="text-gray-300 max-w-lg mx-auto text-lg">
                  Ergenekon R&D Team'in resmi fuar profilini, ürünlerini ve
                  detaylı bilgilerini IDEF dijital platformunda inceleyin.
                </p>
              </div>
